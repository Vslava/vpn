...
- **`specs/IMPLEMENTATION_PLAN.md`** — полный план реализации в 3 фазы:
...
- **`specs/VERIFICATION_P0.md`** — 9 подэтапов, 35+ тестовых сценариев:
...
- **`specs/VERIFICATION_P1.md`** — 5 подэтапов:
...
- **`specs/VERIFICATION_P2.md`** — 6 подэтапов:
...
- `specs/VERIFICATION_P0.md` — verification plan for P0
- `specs/VERIFICATION_P1.md` — verification plan for P1
- `specs/VERIFICATION_P2.md` — verification plan for P2
- `.opencode/skills/verification-plan/SKILL.md` — skill for generating verification plans
- `specs/PRD.md` — product requirements (from previous session)
- `specs/THOUGHTS.md` — architectural decisions (from previous session)
